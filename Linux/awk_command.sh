...
NR: It is used to show the current count of the lines. The awk command performs action once for each line. 
NF: means represent the last field
FS: Use FS for the input field separator (the value of the 'FS' predefined variable).
